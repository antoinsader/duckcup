...
## Front-end 
There is already front-end ready to be connected for the API using the github repo: [<FRONT END REPO>](https://github.com/antoinsader/threadmind/tree/publish/frontend)

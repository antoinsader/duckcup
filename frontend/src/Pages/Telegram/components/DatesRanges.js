...
export default function DatesRanges({
  ...
  const is_specific_date_range_active =
    (start_date_range_filter_value && start_date_range_filter_value !== "") ||
    (end_date_range_filter_value && end_date_range_filter_value !== "");
  ...
  return (
    <div className={styles.date_filters_card_root}>
      <div
        ...
        onClick={(e) => {
          e.preventDefault();
          set_card_content_open((prev_value) => !prev_value);
        }}
      >
        <div className={`${styles.card_header_row} ${styles.col}`}>
          ...
          <p className={styles.card_header_subtitle}>
            {" "}
            Whenever you choose a date here, if there is an active preset date
            filter, it will be deactivated{" "}
          </p>
        </div>
        <div className="d-flex">
          ...
          {card_content_open ? <FaChevronCircleDown /> : <FaChevronCircleUp />}
        </div>
      </div>
      <div
        className={`${styles.date_range_inputs_row} ${!card_content_open ? styles.hidden : ""}`}
      >
